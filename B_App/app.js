...
app.get("/create-customer", authenticateAdminToken, (req, res) => {
...
app.get("/late-loan-payments", authenticateAdminToken, async (req, res) => {
...
app.get("/loans-to-approve", authenticateAdminToken, async (req, res) => {
...
app.get("/approve-loan/:id", authenticateAdminToken, async (req, res) => {
